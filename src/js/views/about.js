	...
	return (
		<div className="wrapper">
			<div className="container-fluid">
				...
				<div className="row row2 py-5 d-block justify-content-end">
					<p className="h5"> Hi, my name is George and I am a web developer </p>
					<p className="h5"> Currently my hobies are coding, coding and coding. </p>
					<p className="h5">
						{" "}
						Before I was a developer I was once an immigrant who one day decided to pursue his dreams in the
						United States, and moved to a brand new country with one suitcase and $227. In the United States I put myself in
                        ...
                        Thanks to my previous progressive corporate HR career in Tech, and in addition to my technical skills, I also bring excellent 
                        people skills, collaborative nature, end-to-end project management and team management experience.  
                        {" "}
					</p>
				</div>
			</div>
