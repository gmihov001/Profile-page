		...
		return (
			<div className="wrapper home">
				<div className="text-left mt-5">
					...
					<p className="ml-5">
						And I made it. I even put myself through college all over again. This part of my life taught me
						that
						<span className="orange h4"> everything is possible </span> and to{" "}
						<span className="red h4"> never give up </span>.
					</p>
					<p className="ml-5">
						Then I built a career in corporate Human Resources. I hired a lot of people and I later
						evaluated their performance. This experience taught me that{" "}
						<span className="lightblue h4"> technical skills can be </span>{" "}
						<span className="magenta h3"> acquired </span>, but
						<span className="lightblue h4"> passion </span>,
						<span className="orange h4"> positive attitude </span>,
					...
					<p>
						So if you are looking to hire someone with the right combination of skills, attitude and
						passion,
						<span className="lightgreen h3">
							<br />I may just be the <span className="orange h3"> best addition </span> to your
							development team{" "}
						</span>
						<Link to="/about">
